<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="UpdateInfoStudnet.aspx.cs" Inherits="UpdateInfoStudnet" %>
...
<table>
   ...
   <tr>
        <td class="style2"> 
            <asp:Label ID="label" runat="server" Text="Sid"></asp:Label>
        </td>
        <td>
            <asp:TextBox ID="Sidnumber" runat="server" CssClass="Textbox" Height="28px" 
        ...
        <td>
             <asp:TextBox ID="lastname" runat="server" CssClass="Textbox" Height="28px" 
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                 ErrorMessage="Required Last Name" ControlToValidate="lastname" 
                 ForeColor="Red" ValidationGroup="text"></asp:RequiredFieldValidator>
        </td>
    </tr>
     <tr>
        ...
        <td>
            ...
            ErrorMessage="Wrong Email ID Formet" ForeColor="Red" ControlToValidate="Email" 
     ...
     <tr>
        ...
        <td> <div id="n">
          ...
          Day  <asp:DropDownList ID="day" runat="server" ValidationGroup="text">
            ...
            &nbsp;
            Month
            <asp:DropDownList ID="month" runat="server" ValidationGroup="text">
             <asp:ListItem></asp:ListItem>
            ...
            <div id="o">
            &nbsp;&nbsp;Year
            <asp:DropDownList ID="year" runat="server" ValidationGroup="text">
             <asp:ListItem></asp:ListItem>
     ...
     <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                 ErrorMessage="Required Blood Group" ControlToValidate="DropDownList2" 
                 ForeColor="Red" ValidationGroup="text"></asp:RequiredFieldValidator>
        </td>
    </tr>
    ...
    <td>
        <asp:FileUpload ID="FileUpload1" runat="server" ValidationGroup="text1"/>
