  ...
  <div class="grid">
    ...
    <form class="form login" id="f2" runat="server">
     <div class="form__field">
      ...
      <asp:TextBox ID="sid" runat="server" placeholder="User ID"></asp:TextBox>
      </div>
      <div class="form__field">
        <label for="login__username"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Username</span></label>
      ...
      <asp:Button ID="StudentLoginButton" runat="server" Text="Login" 
              onclick="StudentLoginButton_Click" />
      </div>

    </form>
     <p class="text--center">
         <asp:HyperLink ID="HyperLink1" runat="server" 
             NavigateUrl="~/PasswordForgotStudent.aspx">Forgot Password</asp:HyperLink>
